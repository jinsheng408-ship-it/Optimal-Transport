...
├── sinkhorn.html       # Interactive visualisation (choose any distribution pair)
├── eda.html            # 5-step statistical EDA pipeline (Gaussian sampling → transport)
├── style.css           # Shared stylesheet
├── script.js           # Distribution generation + Sinkhorn solver (used by sinkhorn.html)
└── README.md           # This file
```
...
| [EDA Pipeline](eda.html) | 5-step workflow: generate Gaussian samples → explore → test normality → compare CDFs → compute transport plan. |